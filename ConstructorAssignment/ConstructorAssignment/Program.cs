...
namespace ConstructorAssignment
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            var bookOne = new Book("Rooted in Hope"); //Instantiates a Book object without declaring its datatype. Using the generic var keyword and let C# figure out the datatype
            ...
            Book bookTwo = new Book("Dragonbreath", 20); //Instantiates another Book object declaring Book at the datatype, we give two arguments here
